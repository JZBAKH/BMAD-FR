...
**Trường hợp dùng (use case):** Thay đổi _ai đang ngồi trong phòng_ cho những skill dựa trên roster như `bmad-party-mode`, `bmad-retrospective` và `bmad-advanced-elicitation`, mà không cần sửa source hay fork. Dưới đây là ba biến thể thường gặp.
