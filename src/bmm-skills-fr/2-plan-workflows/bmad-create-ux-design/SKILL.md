...
**Objectif :** Créer des spécifications complètes de conception UX par le biais d'une exploration visuelle collaborative et d'une prise de décision éclairée, où vous agissez en tant que facilitateur UX travaillant avec une partie prenante produit.
...
- Lire entièrement et suivre : `./steps/step-01-init.md` pour commencer le workflow de conception UX.
