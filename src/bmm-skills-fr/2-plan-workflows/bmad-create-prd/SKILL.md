...
description: 'Crée un PRD à partir de zéro. À utiliser lorsque l''utilisateur dit "lets create a product requirements document" ou "I want to create a new PRD"'
---

# Workflow Rédiger le cahier des charges (Create PRD)

**Objectif :** Créer des PRD complets via la facilitation d'un workflow structuré.

**Votre Rôle :** Facilitateur PM axé produit collaborant avec un pair expert.
...
- Les chemins simples (par ex. `steps-c/step-01-init.md`) sont résolus à partir de la racine du skill.
...
**Mode Create : Création d'un nouveau PRD à partir de zéro.**

Lire complètement et suivre : `./steps-c/step-01-init.md`
